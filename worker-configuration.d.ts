/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.mcp.jsonc` (hash: 9837d24aba0e706fd824e2dd8edbeccb)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_ORIGIN: "https://automated-co-whatsapp-mcp.danielx9.workers.dev";
	META_APP_ID: "922129513848674";
	META_GRAPH_API_VERSION: "v25.0";
	META_EMBEDDED_SIGNUP_SESSION_VERSION: "4";
	META_SANDBOX_TENANT_ID: "automated-co-sandbox";
	META_SANDBOX_WABA_ID: "1750414909526935";
	META_SANDBOX_PHONE_NUMBER_ID: "1234410169764892";
	OAUTH_SIGNING_KEY_ID: "wa-pilot-2026-09-07-1";
	...
	CONVERSATION_INACTIVE_RETENTION_DAYS: "365";
	CONVERSATION_PENDING_STATUS_RETENTION_DAYS: "7";
	CONVERSATION_RETENTION_INTERVAL_HOURS: "24";
	CONVERSATIONS: DurableObjectNamespace<import("./src/mcp/persistentWorker").WhatsAppConversationDurableObject>;
	PILOT_INSTALLATIONS: DurableObjectNamespace<import("./src/mcp/persistentWorker").WhatsAppPilotInstallationDurableObject>;
	OAUTH_STATE: DurableObjectNamespace<import("./src/mcp/persistentWorker").WhatsAppOAuthStateDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/mcp/persistentWorker");
		durableNamespaces: "WhatsAppConversationDurableObject" | "WhatsAppPilotInstallationDurableObject" | "WhatsAppOAuthStateDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "META_APP_ID" | "META_GRAPH_API_VERSION" | "META_EMBEDDED_SIGNUP_SESSION_VERSION" | "META_SANDBOX_TENANT_ID" | "META_SANDBOX_WABA_ID" | "META_SANDBOX_PHONE_NUMBER_ID" | "OAUTH_SIGNING_KEY_ID" | "OAUTH_CLIENT_ID" | "OAUTH_REDIRECT_URI" | "CONVERSATION_MESSAGE_RETENTION_DAYS" | "CONVERSATION_INACTIVE_RETENTION_DAYS" | "CONVERSATION_PENDING_STATUS_RETENTION_DAYS" | "CONVERSATION_RETENTION_INTERVAL_HOURS">> {}
}
